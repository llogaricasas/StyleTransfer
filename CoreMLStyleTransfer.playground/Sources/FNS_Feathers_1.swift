...
public class FNS_Feathers_1Input : MLFeatureProvider {
...
public class FNS_Feathers_1Output : MLFeatureProvider {
...
public class FNS_Feathers_1 {
    ...
    */
    ...
    public convenience init() {
        let bundle = Bundle(for: FNS_Feathers_1.self)
        let assetPath = bundle.url(forResource: "FNS_Feathers_1", withExtension:"mlmodelc")
    ...
    */
    public func prediction(input: FNS_Feathers_1Input) throws -> FNS_Feathers_1Output {
        let outFeatures = try model.prediction(from: input)
        let result = FNS_Feathers_1Output(outputImage: outFeatures.featureValue(for: "outputImage")!.imageBufferValue!)
        return result
    }
    ...
    /**
        ...
        - returns: the result of the prediction as FNS_Feathers_1Output
    */
    public func prediction(inputImage: CVPixelBuffer) throws -> FNS_Feathers_1Output {
        let input_ = FNS_Feathers_1Input(inputImage: inputImage)
