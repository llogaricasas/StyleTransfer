...
public class FNS_La_Muse_1Input : MLFeatureProvider {
...
public class FNS_La_Muse_1Output : MLFeatureProvider {
...
public class FNS_La_Muse_1 {
    ...
    */
    ...
    public convenience init() {
        let bundle = Bundle(for: FNS_La_Muse_1.self)
        let assetPath = bundle.url(forResource: "FNS_La_Muse_1", withExtension:"mlmodelc")
    ...
    /**
        ...
        - parameters:
           - input: the input to the prediction as FNS_La_Muse_1Input
        - throws: an NSError object that describes the problem
        - returns: the result of the prediction as FNS_La_Muse_1Output
    */
    public func prediction(input: FNS_La_Muse_1Input) throws -> FNS_La_Muse_1Output {
        let outFeatures = try model.prediction(from: input)
        let result = FNS_La_Muse_1Output(outputImage: outFeatures.featureValue(for: "outputImage")!.imageBufferValue!)
        return result
    }
    ...
    /**
        ...
        - returns: the result of the prediction as FNS_La_Muse_1Output
    */
    public func prediction(inputImage: CVPixelBuffer) throws -> FNS_La_Muse_1Output {
        let input_ = FNS_La_Muse_1Input(inputImage: inputImage)
